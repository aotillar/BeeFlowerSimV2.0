...
def tcf_monthly_precipitation(x):
    ...
    """
    return -3.554318e+02 + 9.461590e+02 * x - 8.375958e+02 * x ** 2 + 3.640662e+02 * x ** 3 - 8.735626e+01 * x ** 4 \
    + 1.214157e+01 * x ** 5 - 9.741451e-01 * x ** 6 + 4.191430e-02 * x ** 7 - 7.495953e-04 * x ** 8


def interpolate_precipitation(width, height, point_number, month_number, standard_deviation, tp_function,
                              interpolation_function='multiquadric'):
    """
    interpolate_precipitation(0,100,100,1,6)
